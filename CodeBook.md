...
All variables & data are described very well in the original source directory which is freely available here:

https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip

The summaries of these two components are directly quoted from the referenced sub file of that zip directory.

### I) Variables
Quoted from the features_info.txt file included in the source zip file.

The Variables are described as follows in the 
...
The following is a short description of the transformations performed on the raw data by my run_analysis.R script.
